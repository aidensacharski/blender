...
set(CPACK_PACKAGE_INSTALL_DIRECTORY "BDK ${MAJOR_VERSION}.${MINOR_VERSION}")
...
# BDK Installer Upgrade ID
set(CPACK_WIX_UPGRADE_GUID "809F8F5F-1B89-4343-A79B-C4D6252CF350")
...
if(WIN32)
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "Darklight Games/BDK ${MAJOR_VERSION}.${MINOR_VERSION}")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "Darklight Games/BDK ${MAJOR_VERSION}.${MINOR_VERSION}")
...
set(CPACK_PACKAGE_EXECUTABLES "blender-launcher" "BDK ${MAJOR_VERSION}.${MINOR_VERSION}")
set(CPACK_CREATE_DESKTOP_LINKS "blender-launcher" "BDK ${MAJOR_VERSION}.${MINOR_VERSION}")
